# -*- coding: utf-8 -*-
#
# alchemtest documentation build configuration file, created by
...
htmlhelp_basename = 'alchemtestdoc'
...
latex_documents = [
    (master_doc, 'alchemtest.tex', u'alchemtest Documentation',
...
man_pages = [
    (master_doc, 'alchemtest', u'alchemtest Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'alchemtest', u'alchemtest Documentation',
     author, 'alchemtest', 'One line description of project.',
     'Miscellaneous'),
]
